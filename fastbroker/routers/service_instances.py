...
from fastbroker.components import (
    api_version,
...
@router.put(
    ...
    responses={
        200: {"model": ServiceInstanceProvisionResponse, "description": "OK"},
        201: {"model": ServiceInstanceProvisionResponse, "description": "Created"},
        202: {"model": ServiceInstanceAsyncOperation, "description": "Accepted"},
...
@router.delete(
    ...
    responses={
        200: {"model": {}, "description": "OK"},
        202: {"model": AsyncOperation, "description": "Accepted"},
        400: {"model": Error, "description": "Bad Request"},
        410: {"model": Error, "description": "Gone"},
    },
)
...
@router.get(
    ...
    responses={
        200: {"model": ServiceInstanceResource, "description": "OK"},
...
@router.get(
    ...
    responses={
        200: {"model": LastOperationResource, "description": "OK"},
        400: {"model": Error, "description": "Bad Request"},
        410: {"model": Error, "description": "Gone"},
    },
)
